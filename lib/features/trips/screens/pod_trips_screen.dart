...
class PodTripsScreen extends StatefulWidget {
  ...
  @override
  State<PodTripsScreen> createState() => _PodTripsScreenState();
}

class _PodTripsScreenState extends State<PodTripsScreen> {
  ...
  Future<void> _loadTrips() async {
    ...
    // Filter only POD-related trips (Completed, POD Received, POD Submitted)
    final podTrips = allTrips.where((trip) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        heroTag: 'add_trip_fab_pod_trips',
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
