...
class _MyTripsScreenState extends State<MyTripsScreen> {
  ...
  void initState() {
    super.initState();
    // If initial status filters (multiple) are provided, add them all
    if (widget.initialStatusFilters != null) {
      _selectedStatuses.addAll(widget.initialStatusFilters!);
    }
    // If single initial status filter is provided, add it to selected statuses
    else if (widget.initialStatusFilter != null) {
      _selectedStatuses.add(widget.initialStatusFilter!);
    }
    _loadTrips();
  }
  ...
  Future<void> _loadTrips() async {
    ...
    final trips = await ApiService.getAllTrips(); // Load all trips
    setState(() {
      _allTrips = trips;
